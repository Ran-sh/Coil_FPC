function Figure_Plot(result)
%FIGURE_PLOT Show the generated FPC coil in a MATLAB figure window.
%   FIGURE_PLOT(RESULT) draws an overview with all layers overlaid plus
...
if nargin < 1
    error('CircularFPC:Plot', 'CircularFpc.Export.Figure_Plot requires a result struct from CircularFpc.Pipeline.Generate.');
end
