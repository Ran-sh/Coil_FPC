function varargout = AnnotatedPreviews(operation, varargin)
...
% 逐层预览只有 L1 画焊盘与独立电极（见 DxfSvgReports 的 writeSvgLayer），其余层
...
% 与 DxfSvgReports 的铜层调色板一致；audit 会回读源 SVG 实际颜色核对。
