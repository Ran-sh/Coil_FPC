function varargout = DxfSvgReports(operation, varargin)
...
CircularFpc.Export.PublishAtomically(tempDir, formal);
...
if cfg.enablePreview
    ...
    CircularFpc.Export.AnnotatedPreviews('write', cfg, result, previewRoot);
end
...
if cfg.enablePreview
    ...
    CircularFpc.Export.AnnotatedPreviews('audit', fullfile(tempDir, 'preview'), cfg);
end
