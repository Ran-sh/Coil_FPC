function result = Terminal_Routing(cfg, result)
...
validation = CircularFpc.Quality.Result_Validation('validate_result', cfg, result.effectiveDimensions, geom);
...
[boardLoops, actualBridgeWidth, layoutRegions] = ...
    CircularFpc.Geometry.Board_And_Coil('board', cfg, eff, result.activeCoilLayers);
