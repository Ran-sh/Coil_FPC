function result = TerminalRouting(cfg, result)
...
validation = CircularFpc.Quality.ResultValidation('validate_result', cfg, result.effectiveDimensions, geom);
...
[boardLoops, actualBridgeWidth, layoutRegions] = ...
    CircularFpc.Geometry.BoardAndCoil('board', cfg, eff, result.activeCoilLayers);
