...
if contactArcSizing && ~validation.outerViaContactsMeasured
    error('CircularFPC:GeometryInfeasible', ...
        ['Outer-via contact metadata is incomplete after %d automatic sizing ', ...
        'passes: at least one OUTER_TRANSITION via is missing a measured ', ...
        'sweep/radius on one of its two sides.'], maxOuterSizingPasses);
end
