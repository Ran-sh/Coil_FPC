...
function testManualConfigIsIndependentOfAutomaticBendSweep(testCase)
cfg = circular_fpc_default_config(struct( ...
    'terminalPlacementMode', 'manual', ...
    'minCopperInteriorAngleDeg', 100));
verifyEqual(testCase, cfg.terminalPlacementMode, 'manual');
verifyEqual(testCase, cfg.minCopperInteriorAngleDeg, 100);
end
