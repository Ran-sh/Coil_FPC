...
rows = [ ...
    ...
    minimumRow('COPPER_TO_BOARD', cfg.edgeClearance, rules.minCopperToBoardMm, rules); ...
    minimumRow('PAD_TO_TRACE', cfg.padToCopperClearance, rules.minPadToTraceMm, rules); ...
    minimumRow('VIA_TO_TRACE', min(cfg.viaToCopperClearance, ...
        cfg.outputViaToCopperClearance), rules.minViaToTraceMm, rules); ...
