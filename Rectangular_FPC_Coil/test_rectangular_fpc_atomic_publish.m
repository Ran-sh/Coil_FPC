...
assertError(testCase, @() RectangularFpc.Publish.Publish_Atomically( ...
...
RectangularFpc.Publish.Publish_Atomically(paths.staging, paths.output, mover);
...
verifyTrue(testCase, isfile(fullfile(paths.output, 'old_marker.txt')));
verifyFalse(testCase, isfile(fullfile(paths.output, 'new_marker.txt')));
verifyTrue(testCase, RectangularFpc.Publish.Publish_Atomically( ...
...
RectangularFpc.Publish.Publish_Atomically(stagingName, outputName);
