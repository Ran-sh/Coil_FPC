function varargout = Board_Outline(operation, varargin)
%BOARD_OUTLINE Board outline construction primitives.
...
outlineXY = RectangularFpc.Geometry.Path_Geometry('remove_duplicates', outlineXY, tol);
outlineXY = RectangularFpc.Geometry.Path_Geometry('remove_zero_length', outlineXY, tol);
