function varargout = Board_And_Coil(operation, varargin)
%BOARD_AND_COIL Stable private geometry dispatcher.
...
switch operation
    case {'turn_limits', 'spiral', 'derived_parameters', 'build_layers'}
        [varargout{1:nargout}] = RectangularFpc.Geometry.Coil_Spiral( ...
            operation, varargin{:});
    case {'plan_vias', 'auto_output_via'}
        [varargout{1:nargout}] = RectangularFpc.Geometry.Via_Planner( ...
            operation, varargin{:});
    case 'smooth_lead'
        [varargout{1:nargout}] = RectangularFpc.Geometry.Lead_Router( ...
            operation, varargin{:});
    case 'board_outline'
        [varargout{1:nargout}] = RectangularFpc.Geometry.Board_Outline( ...
            operation, varargin{:});
