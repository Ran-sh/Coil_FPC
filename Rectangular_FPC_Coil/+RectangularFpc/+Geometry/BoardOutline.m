function varargout = BoardOutline(operation, varargin)
...
outlineXY = RectangularFpc.Geometry.PathGeometry('remove_duplicates', outlineXY, tol);
outlineXY = RectangularFpc.Geometry.PathGeometry('remove_zero_length', outlineXY, tol);
