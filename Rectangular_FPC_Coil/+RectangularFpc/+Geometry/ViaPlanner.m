function varargout = ViaPlanner(operation, varargin)
...
manualBoardXY = RectangularFpc.Geometry.BoardOutline('board_outline', cfg);
...
for k = 1:cfg.layerCount - 1
    xy = RectangularFpc.Geometry.PathGeometry('user_to_internal', xyUser(k, :), cfg);
