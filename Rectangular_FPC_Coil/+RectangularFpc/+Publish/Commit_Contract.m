function [committed, reason] = Commit_Contract(outputFolder)
%COMMIT_CONTRACT Verify a complete published handoff.
...
outputFolder = RectangularFpc.Publish.Publish_Paths('normalize', outputFolder);
