...
正式资格会对最终几何实测，包括过孔焊盘边缘到真实板框至少 0.50 mm。
...
规则于 2026-09-04 核对，来源为 [JLCPCB FPC 能力表](https://jlcpcb.com/capabilities/flex-pcb-capabilities/)、[FPC 间距指南](https://jlcpcb.com/help/article/fpc-design-clearance)及 [via/pad 孔径公差说明](https://jlcpcb.com/help/article/difference-and-tolerance-explanation-between-via-and-pad-holes)。最终规则、覆盖项与来源写入制造报告。
