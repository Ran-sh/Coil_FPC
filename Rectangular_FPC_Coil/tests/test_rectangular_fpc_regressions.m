...
verifyEqual(testCase, result.totalTraceLengthMm, ...
    7549.4030872459300, 'AbsTol', 1e-6);
verifyEqual(testCase, result.estimatedDcResistanceOhm, ...
    18.593101317731400, 'AbsTol', 1e-9);
...
expectedPathHashes = { ...
    ...
    '3ae6091833b5e18119c430edac5040f7f7a6185b34dd375556e59e3e580854a5'; ...
    '686d635feae2bb365bc065db00ab557c563c6adb65890c8bb1bc63e82ae44d9b'; ...
...
verifyEqual(testCase, vertcat(result.vias.xy), [ ...
    34.34, 0.0; 40.80, 0.0; 32.34, 0.0; 40.80, -1.10], ...
    'AbsTol', cfg.geometryTolerance);
